...
Invoke-RequiredExample -Label "11_findalldevs_lookupdev_c" -Executable "11_findalldevs_lookupdev_c.exe" -Expected "Devices returned by zpcap_findalldevs:"
...
Invoke-RequiredExample -Label "15_findalldevs_lookupdev_cpp" -Executable "15_findalldevs_lookupdev_cpp.exe" -Expected "Devices returned by zpcap_findalldevs:"
